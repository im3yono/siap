...
<div class="row">
	...
	<div class="col-auto">
		<button data-route="up_staf" data-id="v_guru" type="button" class="btn btn-outline-primary"><i class="bi bi-upload"></i> Upload Data</button>
	</div>
</div>
<div class="row mt-5">
	<div class="table-responsive">
		<table class="table table-hover" id="jtable">
			...
			<tbody>
				...
				$stmt = $pdo_conn->prepare("SELECT * FROM tb_dstaf");
				$stmt->execute();
				...
				?>
					...
					<tr>
						<td><?= $notbl++; ?>
							<img src="<?= ft($row['id_staf'], "staf"); ?>" alt="<?= $row['id_staf']; ?>" class="img-thumbnail shadow" style="width: 75px; height: 100px; object-fit: cover;">
						</td>
						<td><?= $row['id_staf'].'<br>'.$row['nip'].'<br>'.$row['nuptk']; ?></td>
						...
						<td>
							<div class="row g-1">
								<div class="col-12">
									<button class="btn btn-sm btn-primary" onclick="viewData('<?= $row['id_staf']; ?>')" style="width: 80px;"><i class="bi bi-card-text"></i> Lihat</button>
								</div>
								<div class="col-12">
									<button data-route="edt_sis" data-id="<?= $row['id_staf']; ?>" class="btn btn-sm btn-info" style="width: 80px;"><i class="bi bi-pencil"></i> Edit</button>
								</div>
								<div class="col-12">
...
<!-- Modal -->
<div class="modal fade" id="d_guru">
	<div class="modal-dialog modal-xl modal-dialog-scrollable">
		<div class="modal-content">
			<div class="modal-header">
				<h1 class="modal-title fs-5" id="d_guruLabel">Data Siswa</h1>
