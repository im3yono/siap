...
<div class="row">
	...
	<div class="col-auto">
		<button data-route="up_staf" data-id="guru" type="button" class="btn btn-outline-primary"><i class="bi bi-upload"></i> Upload Data</button>
	</div>
</div>
<div class="row mt-5">
	...
	<div class="modal-dialog modal-xl modal-dialog-scrollable">
		<div class="modal-content">
			<div class="modal-header">
				<h1 class="modal-title fs-5" id="d_guruLabel">Data Guru</h1>
