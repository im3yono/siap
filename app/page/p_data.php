	...
	<div class="col-xl-4">
		<div class="card mb-3">
			<div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
				...
				<h3>ID AKUN</h3>
				<h3 class="fw-semibold">ID AKUN 2</h3>
		...
		<div class="card">
			<div class="card-title px-3">
				<div class="row text-center px-3">Ganti Password</div>
			</div>
		...
		<div class="card">
			<div class="card-body pt-3">
				...
				<ul class="nav nav-tabs nav-tabs-bordered">
					...
					<li class="nav-item">
						<button class="nav-link active" data-bs-toggle="tab" data-bs-target="#profile-overview">Data Siswa</button>
					</li>

					<li class="nav-item">
						<button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit">Edit Siswa</button>
					</li>
				...
				<div class="tab-content pt-2">
					...
					<div class="tab-pane fade show active profile-overview" id="profile-overview">
						...
						<h5 class="card-title">Profil Lengakap</h5>

						<div class="row">
							<div class="col-lg-3 col-md-4 label ">Nama Lengkap</div>
							<div class="col-lg-9 col-md-8 fw-semibold"><?= $row['nm']; ?></div>
						</div>
						...
						<div class="row">
							<div class="col-lg-3 col-md-4 label">Berat, Tinggi Badan & Lingkar Kepala</div>
							<div class="col-lg-9 col-md-8">???</div>
						</div>

						<div class="row">
							<div class="col-lg-3 col-md-4 label">Jumlah Saudara</div>
							<div class="col-lg-9 col-md-8">??? Orang</div>
						</div>

						<div class="row">
							<div class="col-lg-3 col-md-4 label">Tinggal</div>
							<div class="col-lg-9 col-md-8">???</div>
						</div>

						<div class="row">
							<div class="col-lg-3 col-md-4 label">Trasportasi</div>
							<div class="col-lg-9 col-md-8">???</div>
						</div>
						...
						<!-- AYAH -->
						<h6 class="fw-semibold">Data Ayah</h6>
						<div class="row">
							<div class="col-lg-3 col-md-4 label">Nama Ayah</div>
							<div class="col-lg-9 col-md-8 fw-semibold">???</div>
						</div>
						...
						<!-- IBU -->
						<h6 class="fw-semibold">Data Ibu</h6>
						<div class="row">
						...
						<!-- Wali -->
						<?php if (!empty($w_nm)) { ?>
							<h6 class="fw-semibold">Data Wali</h6>
							<div class="row">
								<div class="col-lg-3 col-md-4 label">Nama Wali</div>
								<div class="col-lg-9 col-md-8 fw-semibold"><?php echo $w_nm ?></div>
							</div>

							<div class="row">
								<div class="col-lg-3 col-md-4 label">Tahun Lahir</div>
								<div class="col-lg-9 col-md-8"><?php echo $w_tl ?></div>
							</div>

							<div class="row">
								<div class="col-lg-3 col-md-4 label">Pendidikan Terakhir</div>
								<div class="col-lg-9 col-md-8"><?php echo $w_pddk ?></div>
							</div>

							<div class="row">
								<div class="col-lg-3 col-md-4 label">Pekerjaan</div>
								<div class="col-lg-9 col-md-8"><?php echo $w_kerja ?></div>
							</div>

							<div class="row">
								<div class="col-lg-3 col-md-4 label">Penghasilan</div>
								<div class="col-lg-9 col-md-8"><?php echo $w_hasil ?></div>
							</div>
						<?php } ?>
