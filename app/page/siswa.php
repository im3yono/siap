...
<div class="row g-2">
	...
	<div class="col-auto">
		<button onclick="viewData('ktpl')" type="button" class="btn btn-outline-secondary"><i class="bi bi-person-vcard"></i> Kartu Pelajar</button>
	</div>
</div>
<div class="row mt-5">
...
<script>
	function viewData(prd, id = '') {
		...
		if (prd == 'add') {
			$('#d_siswaLabel').text('Tambah Data Siswa');
			$('#md_btn').hide();
		}
		if (prd == 'ktpl') {
			$('#d_siswaLabel').text('Cetak Kartu Pelajar');
			$('#md_btn').hide();
		}
